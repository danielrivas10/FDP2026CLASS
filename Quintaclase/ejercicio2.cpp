...
int main()
{
    ...
    else
    {
        ...
        for (int i = 2; i * i <= n; i++) // Es una secuencia hasta que i es mayor que n.
        {
            cout<<n<<endl; // Solo muestra otra vez el número 
            cout<<i<<endl; //Divisores del numero que estoy ingresando
            if (n % i == 0)
